...
var onReceiveCallback = function(info) {
	...
	if(serialRevStringState == true) {
		...
		imageData = imageData + receiceString;

		imageLength = imageData.length;

		if(imageData[imageLength - 1] == "\n" && imageData[imageLength - 2] == "\r") {

			html = '<img  style="width: 50%;" src="data:image/png;base64,' + imageData.substring(0, imageLength - 2) + '">';
			$("#aaa").html(html);
			imageData = '';
		}
 ...
 * 描述：
 */
$("#OpenMV").click(function() {
	nw.Shell.openExternal('http://www.openmv.net.cn/');
});
